            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3">
                    <div class="contact-content mb-100">
                        ...
                        <div class="single-contact-info d-flex align-items-center">
                            ...
                            <p>Büyükdere Meşelik Yerleşkesi, 26040 Odunpazarı/Eskişehir</p>
                        </div>
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="map-area mb-100">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8189.413869908365!2d30.479406833939592!3d39.74944034669168!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cc16539e809751%3A0x31c84ff42550b9bd!2sMatematik%20ve%20Bilgisayar%20Bilimleri!5e0!3m2!1str!2str!4v1711915660765!5m2!1str!2str"  allowfullscreen></iframe>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="contact-form-area">
                        <form id="iletisim_formu" action="islem_ticket.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea name="message" class="form-control" cols="30" rows="10" placeholder="Mesaj"></textarea>
                                    </div>
                                </div>

...
$event_id = $_GET['id'];
$sorgu_event = mysqli_query($conn, "select * from event where ID = $event_id");
$event = mysqli_fetch_array($sorgu_event);
?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3">
                    <div class="contact-content mb-100">
                        ...
                        <div class="single-contact-info d-flex align-items-center">
                            ...
                            <p><?php echo $event['phone_number'] ?></p>
                        </div>
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="map-area mb-100">
                        <iframe src="<?php echo $event['location'] ?>"  allowfullscreen></iframe>
                    </div>
                </div>

...
?>
                ...
                <div class="container-fluid">
					...
					<h1 class="h3 mb-4 text-gray-800">Yeni Album Ekleme</h1>					
						<div class="card-body">
		...
		<tr>
		<td>
			  <form id='album' name='album' method="post" enctype="multipart/form-data" action="isle.php?islem=album_ekle">  
			  <table class="table table-bordered" cellpadding="0" cellspacing="0">
				  <tr>
					<td><strong>Resmi</strong></td>
				  ...
				  <tr>
					  ...
					  <td style="text-align:left; vertical-align: middle;">
							<input type='submit' name='submit' style="background-color: #124559;color: white;border-radius: 7px;" value='Sanatçı Kaydet'>
						</td>
				 </tr>
				</table>        
			  </form>
  ...
  $('form#album').submit(function(event) {
    ...
    var form = $(this);
    var formVeri= new FormData($('form#album')[0]);   
    $.ajax({

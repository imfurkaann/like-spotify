...
include('../baglan.php');
    ...
    $sorgu_uye = mysqli_query($conn,"select * from uyeler");
    $genel_uye = mysqli_fetch_array($sorgu_uye);
                                ...
                                <div class="p-5">
                                    ...
                                    <form id='sifre_sifirlama' method='post' action='' class="user">
                                        <div class="form-group">
                                            <input value='<?php echo $genel_uye['mail'] ?>' name='kullanici' type="text" readonly  class="form-control form-control-user"

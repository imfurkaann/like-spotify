...
<head>
    ...
    <title>Spotimy Yönetim Paneli</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><b>Spotimy Yönetim Sistemi</b></h1>
                                    </div>
                                    <form method='post' id="giris_form" action='' class="user">
										...
										<input type="submit" value="Giriş Yapmak İçin Tıklayınız" name="submit" style='height:40px;width:100%;font-size:13px;background-color: #4e73df;border-color: #4e73df;color: white;border-radius: 5px;'>
                                    </form>
                                    <hr>

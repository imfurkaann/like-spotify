...
?>
		...
		<tr>
		<td>
			  <form id='yazar_bilgileri' name='yazar_bilgileri' method="post" enctype="multipart/form-data" action="isle.php?islem=egitim_ekle">  
			  <table class="table table-bordered" cellpadding="0" cellspacing="0">
				  <tr>
					<td><strong>Eğitim Görseli</strong></td>
					<td><input type='file' accept="image/gif, image/jpg, image/jpeg, image/png" name='resim'></td>
				  </tr>
                  <tr>
					<td><strong>Eğitim Videosu</strong></td>
					<td><input type='file' accept=".mp4" name='video'></td>
				  </tr>
                  <tr>
					<td><strong>Eğitim Seviyesi</strong></td>
					<td><select name="seviye" id="artist">
                  ...
                  <tr>
					<td><strong>Enstrüman Adı</strong></td>
					<td><select name="enstruman" id="artist">
                        <option>Lütfen seçin</option>
                  ...
                  <tr>
					<td><strong>Eğitmen Adı</strong></td>
					<td><input type="text" class="text" required  name='inst_name' /></td>
				  </tr>
                  <tr>
					<td><strong>Eğitim İçeriği</strong></td>
					<td><input type="text" class="text" required  name='icerik' /></td>
				  </tr>
                  <tr>
				  ...
				  <tr>
					  ...
					  <td style="text-align:left; vertical-align: middle;">
							<input type='submit' name='submit' style="background-color: #124559;color: white;border-radius: 7px;" value='Eğitim Kaydet'>
						</td>
				 </tr>
				</table>        
			  </form>

...
?>
                ...
                <div class="container-fluid">
					...
					<h1 class="h3 mb-4 text-gray-800">Yeni şarkı Ekleme</h1>					
						<div class="card-body">
		...
		<td>
			  ...
			  <table class="table table-bordered" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td><input type='file' accept=".mp3" name='music'></td>
				  </tr>
				  <tr>
				  ...
				  <tr>
					  ...
					  <td style="text-align:left; vertical-align: middle;">
							<input type='submit' name='submit' style="background-color: #124559;color: white;border-radius: 7px;" value='Müzik Kaydet'>
						</td>
				 </tr>
				</table>        
			  </form>
